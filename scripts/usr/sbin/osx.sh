...
sudo scutil --set ComputerName "Julia"
sudo scutil --set HostName "Julia"
sudo scutil --set LocalHostName "Julia"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Julia"
